...
public class MemberController {
	...
	@GetMapping("/signup")
	public String signUp(@ModelAttribute("signupRequestDto") SignUpRequestDto signUpRequestDto) {
		// System.out.println("MemberController.signUp");
		return "signup";
	}

	@PostMapping("/signup")
	public String sign_Up(@ModelAttribute @Valid SignUpRequestDto signUpRequestDto) {
